...
export class MaintenanceService {
  ...
  create(body: CreateMaintenance): Observable<any>  { return this.http.post<any>(API, body); }
  update(id: number, body: Partial<CreateMaintenance>): Observable<any> { return this.http.patch<any>(`${API}/${id}`, body); }
